...
class DetailPenerbangan extends Controller
{
    //
    public function detailPenerbangan($id, $departId, $arrivalId, $paxAdult, $paxChildren, $paxInfant, $goDate, $roundTrip, $returnDate, $token){
        ...
        return response(['searchQueries' => $searchQueries, 'searchDataResult' => $searchData], 200);
