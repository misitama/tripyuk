...
function EventManager() { // assumed to be a calendar
	...
	function buildEventSource(sourceInput) { // will return undefined if invalid source
		...
		if (source) {
			...
			// for array sources, we convert to standard Event Objects up frontoffice
	...
	function removeEvents(filter) {
		...
		// This works because they have been converted to official Event Objects up frontoffice.
