...
@section('page_title')
	Role
	<span>
		<a href="{{URL::to('admin/dashboard')}}">Dashboard</a> / <span>Role</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Role
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk meng-edit Role
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Role
		</li>
	</ul>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to('admin/role/create')}}">
							...
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 200px">
										<li>
											<a href="{{URL::to('admin/role/' . $role->id)}}">
										...
										<li>
											<a href="{{URL::to('admin/role/' . $role->id . '/edit')}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to('admin/role/' . $role->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
