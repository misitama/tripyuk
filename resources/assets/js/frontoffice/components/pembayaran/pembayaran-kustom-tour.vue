                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="row pt-3 pb-4">
                                                                ...
                                                                <div class="col-lg-12 text-right pt-3">
                                                                    ...
                                                                    <router-link class="btn btn-primary btn-block" :to="{ name: 'prosespembayaran' }">Bayar Sekarang</router-link>
                                                                </div>
                                    ...
                                    <div class="card-body border-bottom">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 text-right">
                                                <a class="d-block w-100" href="#testingCollapse" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseExample">
                                                    <i class="fa fa-angle-up"></i>
                                                </a>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="collapse show" id="testingCollapse" :key="key">
                                                    <div class="row mt-3 align-items-center">
                                                        <div class="col-lg-3">
                                                            <img class="w-100" src="frontoffice/icons/promo.png">
                                                        </div>
                                                        <div class="col-lg-9">
                                                    ...
                                                    <ul class="list-group border-left border-top border-right border-bottom mt-4">
                                                        ...
                                                        <li class="list-group-item border-0">
                                                            ...
                                                            <div class="clearfix w-100 d-inline-block">
                                                                <div class="w-35 float-left">
                                                                    <h6>testing</h6>
                                                                    <p class="info-input m-0 p-0">Testing</p>
                                                                </div>
                                                        ...
                                                        <li class="list-group-item border-0">
                                                            ...
                                                            <div class="clearfix w-100 d-inline-block">
                                                                ...
                                                                <div class="w-65 float-left">
                                                                    <h6>testing</h6>
                                                                    <p class="info-input m-0 p-0">Teting</p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <a class="mt-4 btn btn-link p-0 pointer text-primary align-right" href="#">Delete Order</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
