...
<head>
  ...
  <title>{{ trans('laravel-filemanager::lfm.title-page') }}|| tes</title>
...
<body>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
            ...
            <input type="hidden" name="token" value="{{\Tymon\JWTAuth\Facades\JWTAuth::getToken()}}">
          </form>
        </div>
  ...
  <script>
    ...
    var jwttoken = "{{ \Tymon\JWTAuth\Facades\JWTAuth::getToken() }}";
  </script>
